...
object Day07 {
  ...
  /**
    * Compute the min fuel needed to align all crabs.
    * Every movement cost 1 fuel.
    */
  ...
  /**
    * Compute the min fuel needed to align all crabs.
    * First movement cost 1 fuel, second 2 fuels, third 3 fuels, ... At the end it costs the sum of movements (ie n*(n+1)/2).
    */
