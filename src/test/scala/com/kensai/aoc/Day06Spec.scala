...
class Day06Spec extends AnyFlatSpec with GivenWhenThen {
  ...
  private lazy val puzzleInputs = readInputFile("src/test/resources/Day06.input")
  private lazy val specInputs = readInputFile("src/test/resources/Day06Spec.input")
