...
class Day09Spec extends AnyFlatSpec with GivenWhenThen {
  ...
  private lazy val puzzleInputs = readInputLines("src/test/resources/Day09.input")
  private lazy val specInputs = readInputLines("src/test/resources/Day09Spec.input")
