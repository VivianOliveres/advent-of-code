...
class Day10Spec extends AnyFlatSpec with GivenWhenThen {
  ...
  private lazy val puzzleInputs = readInputLines("src/test/resources/Day10.input")
  private lazy val specInputs = readInputLines("src/test/resources/Day10Spec.input")
