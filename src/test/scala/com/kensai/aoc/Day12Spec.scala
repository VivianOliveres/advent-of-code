...
class Day12Spec extends AnyFlatSpec with GivenWhenThen {
  ...
  private lazy val puzzleInputs = readInputLines("src/test/resources/Day12.input")
  private lazy val specInputs = readInputLines("src/test/resources/Day12Spec.input")
  ...
  "parse commands from specs" should "return 5 commands" in {
    ...
    val expectedResult = List(Forward(10), North(3), Forward(7), Right(90), Forward(11))
  ...
  "computeManhattanDistance2(Pos(0, 0, E), Pos(10, 1, N)) from spec" should "return 286" in {
    ...
    val result = computeManhattanDistance2(Pos(0, 0, E), Pos(10, 1, N), specInputs)
  ...
  "computeManhattanDistance2 from puzzle" should "return solution" in {
    ...
    val result = computeManhattanDistance2(Pos(0, 0, E), Pos(10, 1, N), puzzleInputs)
