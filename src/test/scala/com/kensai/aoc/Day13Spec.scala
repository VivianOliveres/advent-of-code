...
class Day13Spec extends AnyFlatSpec with GivenWhenThen {
  ...
  private lazy val puzzleInputs = readInputLines("src/test/resources/Day13.input")
  private lazy val specInputs = readInputLines("src/test/resources/Day13Spec.input")
